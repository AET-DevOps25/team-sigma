...
public class DocumentController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Document uploaded successfully", content = @Content(schema = @Schema(implementation = DocumentResponse.class))),
    ...
    public ResponseEntity<DocumentResponse> uploadDocument(
            ...
            @Parameter(description = "Document name", required = true) @RequestParam("name") String name,
            @Parameter(description = "Document description") @RequestParam(value = "description", required = false) String description,
            @Parameter(description = "Lecture ID") @RequestParam(value = "lectureId", required = false) String lectureId) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Documents retrieved successfully", content = @Content(schema = @Schema(implementation = DocumentResponse.class))),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    public ResponseEntity<List<DocumentResponse>> getAllDocuments(
            @Parameter(description = "Lecture ID to filter documents") @RequestParam(value = "lectureId", required = false) String lectureId) {
        try {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Document found", content = @Content(schema = @Schema(implementation = DocumentResponse.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Document updated successfully", content = @Content(schema = @Schema(implementation = DocumentResponse.class))),
            @ApiResponse(responseCode = "404", description = "Document not found"),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    public ResponseEntity<DocumentResponse> updateDocument(
            @Parameter(description = "Document ID", required = true) @PathVariable Long id,
            @Parameter(description = "Document update request", required = true) @Valid @RequestBody DocumentUploadRequest request) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Search completed successfully", content = @Content(schema = @Schema(implementation = DocumentResponse.class))),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Similar documents found", content = @Content(schema = @Schema(implementation = SimilarChunkResponse.class))),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    public ResponseEntity<List<SimilarChunkResponse>> searchSimilarDocuments(
            @Parameter(description = "Search query for similarity", required = true) @RequestParam("q") String query,
            @Parameter(description = "Maximum number of results") @RequestParam(value = "limit", defaultValue = "10") int limit) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Document chunks retrieved successfully", content = @Content(schema = @Schema(implementation = SimilarChunkResponse.class))),
            @ApiResponse(responseCode = "404", description = "Document not found"),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    ...
    public ResponseEntity<List<DocumentResponse>> getDocumentsByContentType(
            @Parameter(description = "Content type to filter by", required = true) @RequestParam("type") String contentType) {
    ...
    public ResponseEntity<Void> deleteDocumentsByLecture(
            @Parameter(description = "Lecture ID", required = true) @PathVariable String lectureId) {
        try {
    ...
    public ResponseEntity<Map<String, Object>> addMessageToConversation(
            @Parameter(description = "Document ID", required = true) @PathVariable Long id,
            @Parameter(description = "Message content", required = true) @RequestBody Map<String, Object> messageRequest) {
